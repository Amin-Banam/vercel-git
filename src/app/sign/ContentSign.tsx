...
export default function ContentSign() {
    ...
    return (
        <div className='min-w-137.5 h-150 px-12 py-16 bg-[rgb(10_10_10)] rounded-xl border border-[rgb(31_31_31)] mt-48 flex flex-col justify-center items-center'>
            <h4 className='font-semibold leading-10 text-3xl tracking-[-1.28] text-center mt-6'>Your first deploy <br />
                is just a sign-up away.
            </h4>
            <div className='min-w-120 mt-10 flex justify-center flex-col items-center'>
            
                <button onClick={handleGoogleSignUp} className='w-95 hover:bg-[#352d2d] border rounded-xl h-13.75 flex justify-center items-center mt-3 border-[rgb(31_31_31)]'>
                    <span className=''>
                ...
                <button onClick={handleGithubSignUp} className='w-95 hover:bg-[#352d2d] border rounded-xl h-13.75 flex justify-center items-center mt-3 border-[rgb(31_31_31)]'>
                    <span className=''>
                ...
                <button onClick={handleAppleSignUp} className='w-95 hover:bg-[#352d2d] border rounded-xl h-13.75 flex justify-center items-center mt-3 border-[rgb(31_31_31)]'>
                    <span className=''>
                ...
                <button className='w-95 hover:bg-[#352d2d] rounded-xl h-13.75 flex justify-center items-center mt-3'>
                    <h5 className='text-[#52A8FF]'>Continue with Email</h5>
                </button>
                <div id="clerk-captcha"></div>
            </div>
            <p className='text-[#A1A1A1] text-xs mt-28'>By joining, you agree to our <span className='font-bold text-white'>Terms of Service</span> and <span className='font-bold text-white'>Privacy Policy</span></p>
        </div>
    )
}
