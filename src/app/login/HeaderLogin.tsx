...
export default function HeaderSign() {
    return (
        <section className='flex bg-black justify-around h-16 fixed top-0 left-0 items-center w-full'>
            <div className='w-[40%] flex h-full items-center'>
                <div className='w-[49%] flex h-full items-center'>
            ...
            <div className='w-[49%] h-full flex items-center justify-end'>
                <Link className='border border-gray-800 py-1.5 px-2.5 rounded-md text-sm hover:bg-[#352d2d]' href='./sign'>Sign Up</Link>
            </div>
        </section>
    )
}