            ...
            <div className='w-200 absolute h-96 top-15 left-0 rounded-2xl hidden group-hover:block bg-black border border-[#171717] overflow-hidden'>
                <section className=' w-full  p-2 transition-all duration-500 h-full  group-hover:flex justify-around'>
                    <div className='w-[33%] flex flex-col justify-around h-full p-3'>
                        <h4 className='w-full text-sm'>AI Cloud</h4>
                        <section className='p-1 flex items-center w-full cursor-pointer s '>
                            <svg height="16" className='border rounded-sm h-8.75 w-8.75 ' strokeLinejoin="round" viewBox="-6 -1 30 16" width="16" ><path d="M2.5 0.5V0H3.5V0.5C3.5 1.60457 4.39543 2.5 5.5 2.5H6V3V3.5H5.5C4.39543 3.5 3.5 4.39543 3.5 5.5V6H3H2.5V5.5C2.5 4.39543 1.60457 3.5 0.5 3.5H0V3V2.5H0.5C1.60457 2.5 2.5 1.60457 2.5 0.5Z" fill="currentColor"></path>
                    ...
                    <div className='w-[33%] flex flex-col justify-around h-full p-3'>
                        ...
                        <section className='p-1 flex items-center w-full cursor-pointer s '>
                            ...
                            <div className='ml-2'>
                                <h4 className=' w-full text-white'>Workflow</h4>
                                <p className='text-xs'>Long-running workflows at scale</p>
                            </div>
                        </section>
                        <section className='p-1 flex items-center w-full cursor-pointer s '>
                            <svg height="16" className='border rounded-sm h-8.75 w-8.75' strokeLinejoin="round" viewBox="-6 -1 30 16" width="16"><path fillRule="evenodd" clipRule="evenodd" d="M8.75 1V1.75V14.25V15H7.25V14.25V1.75V1H8.75ZM3.5 9V9.75V14.25V15H2V14.25V9.75V9H3.5ZM14 6.75V6H12.5V6.75V14.25V15H14V14.25V6.75Z" fill="currentColor"></path></svg>
                            <div className='ml-2'>
                                <h4 className=' w-full text-white'>Observability</h4>
                                <p className='text-xs'>Trace every step</p>
                            </div>
                        </section>
                    </div>
                    {/* ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
                    <div className='w-[33%] flex flex-col  h-full p-3'>
                        <h4 className='w-full text-sm mt-2.5'>Security</h4>
                        <section className='p-1 mt-3.75 flex items-center w-full  cursor-pointer s '>
                            <svg height="16" className='border rounded-sm h-8.75 w-8.75' strokeLinejoin="round" viewBox="-6 -1 30 16" width="16" ><path fillRule="evenodd" clipRule="evenodd" d="M8.75 2.79933C9.19835 2.53997 9.5 2.05521 9.5 1.5C9.5 0.671573 8.82843 0 8 0C7.17157 0 6.5 0.671573 6.5 1.5C6.5 2.05521 6.80165 2.53997 7.25 2.79933V5H7C4.027 5 1.55904 7.16229 1.08296 10H0V13H1V14.5V16H2.5H13.5H15V14.5V13H16V10H14.917C14.441 7.16229 11.973 5 9 5H8.75V2.79933ZM7 6.5C4.51472 6.5 2.5 8.51472 2.5 11V14.5H13.5V11C13.5 8.51472 11.4853 6.5 9 6.5H7ZM7.25 11.25C7.25 12.2165 6.4665 13 5.5 13C4.5335 13 3.75 12.2165 3.75 11.25C3.75 10.2835 4.5335 9.5 5.5 9.5C6.4665 9.5 7.25 10.2835 7.25 11.25ZM10.5 13C11.4665 13 12.25 12.2165 12.25 11.25C12.25 10.2835 11.4665 9.5 10.5 9.5C9.5335 9.5 8.75 10.2835 8.75 11.25C8.75 12.2165 9.5335 13 10.5 13Z" fill="currentColor"></path></svg>
                            <div className='ml-2'>
                                <h4 className=' w-full text-white'>Bot Managment</h4>
                                <p className='text-xs'>Scalable bot protection</p>
                            </div>
                        </section>
                        <section className='p-1 flex mt-3.75 items-center w-full cursor-pointer s '>
                            ...
                            <div className='ml-2'>
                                <h4 className=' w-full text-white'>BotID</h4>
                                <p className='text-xs'>Invisible CAPTCHA</p>
                            </div>
                        </section>
                        <section className='p-1 mt-3.75 flex items-center w-full cursor-pointer s '>
                            ...
                            <div className='ml-2'>
                                <h4 className=' w-full text-white'>Platform Security</h4>
                                <p className='text-xs'>DDos Protection, Firewall</p>
                            </div>
                        </section>
                        <section className='p-1 mt-3.75 flex items-center w-full cursor-pointer s '>
                            <svg className='border rounded-sm h-8.75 w-8.75' height="16" strokeLinejoin="round" viewBox="-6 -1 30 16" width="16"><g clipPath="url(#clip0_4629_2028)">
                            ...
                            <div className='ml-2'>
                                <h4 className=' w-full text-white'>Web Application Firewall</h4>
                                <p className='text-xs'>Grannular, custom protection</p>
                            </div>
                        </section>
                    </div>
                </section>
